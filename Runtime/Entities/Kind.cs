...
namespace Emas
{
    /// <summary>Identifies an application-defined category of ghost.</summary>
    [Serializable]
    ...
    public struct Kind : IEquatable<Kind>, IComparable<Kind>
    {
        ...
        /// <summary>Creates a kind with a stable, case-sensitive identifier.</summary>
        ...
        /// <value>The exact, case-sensitive identifier.</value>
        public string Id
        {
            get { return _id; }
        }

        /// <summary>Gets whether the kind is valid.</summary>
        /// <value>True when the identifier is non-empty.</value>
        public bool IsValid
        {
        ...
        /// <summary>Compares two kinds.</summary>
        ...
        /// <summary>Compares two kinds using ordinal identifier ordering.</summary>
        /// <param name="left">The first kind.</param>
        /// <param name="right">The second kind.</param>
        /// <returns>True when the first identifier is lower.</returns>
        public static bool operator <(Kind left, Kind right)
        {
        ...
        /// <param name="left">The first kind.</param>
        /// <param name="right">The second kind.</param>
        /// <returns>True when the first identifier is greater.</returns>
        public static bool operator >(Kind left, Kind right)
        {
            return left.CompareTo(right) > 0;
        }
        ...
        /// <param name="left">The first kind.</param>
        /// <param name="right">The second kind.</param>
        /// <returns>True when the first identifier is no greater.</returns>
        public static bool operator <=(Kind left, Kind right)
        {
            return left.CompareTo(right) <= 0;
        }
        ...
        /// <param name="left">The first kind.</param>
        /// <param name="right">The second kind.</param>
        /// <returns>True when the first identifier is no lower.</returns>
        public static bool operator >=(Kind left, Kind right)
        {
            return left.CompareTo(right) >= 0;
        }
