...
namespace Emas
{
    ...
    public sealed class View : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets the current requested detail level.
        /// </summary>
        /// <value>
        /// The requested level; the selected prefab may support a lower level.
        /// </value>
        public DetailLevel RequestedDetailLevel
        {
            get
            {
                return _requestedDetailLevel;
            }
        }

        /// <summary>
        /// Binds this view to a ghost.
        /// </summary>
        /// <param name="ghost">
        /// The represented ghost.
        /// </param>
