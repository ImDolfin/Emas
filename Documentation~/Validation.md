...
The full Unity **2022.3.62f3** test project passed **16 EditMode** and **269 PlayMode** tests on **2026-09-26**, package **0.1.0**. This includes imported sample consistency, the serialized `ManifestationVariant` asset in the Callbacks scene, both quick-start scenes, isolated and nested prefab realms, manifestation blueprint defaults and anchor overrides, reference frames, startup cleanup and queries across live realms. The ignored XML and logs are in `Tests/Unity~/TestResults/ManifestationAssets/`.

| Editor | Test Framework | EditMode | PlayMode |
| --- | --- | --- | --- |
| 2022.3.62f3 (`96770f904ca7`) | 1.1.33 | 16 passed | 269 passed |
