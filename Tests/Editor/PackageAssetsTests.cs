...
{
    /// <summary>Verifies Unity imports the package's component and blueprint scripts.</summary>
    public sealed class PackageAssetsTests
    {
        /// <summary>A package script imports as its declared public type.</summary>
        ...
        {
            var script = AssetDatabase.LoadAssetAtPath<MonoScript>("Packages/com.emas.core/" + relativePath);
